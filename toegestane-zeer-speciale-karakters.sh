...
echo -e "next\tword\tbasiswoord\talternatief\taantekeningen">header
cat toegestane-zeer-speciale-karakters.tsv>>header
mv -f header toegestane-zeer-speciale-karakters.tsv
